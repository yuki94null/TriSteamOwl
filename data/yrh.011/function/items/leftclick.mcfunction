# 遷移
    # リロード
        execute if items entity @s[tag=!yrh.011.reload.while] weapon.mainhand *[minecraft:custom_data~{yrh.011:{item:"tristeamowl"}}] \
    ...
    # チャージ
        execute if items entity @s[tag=!yrh.011.recharge.while] weapon.mainhand *[minecraft:custom_data~{yrh.011:{item:"tristeamowl"}}] \
