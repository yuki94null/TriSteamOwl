...
particle flame ~ ~ ~ 0.125 0.125 0.125 0.0 1 normal @a

# ダメージ
execute positioned ~-0.25 ~-0.25 ~-0.25 as @e[dx=-0.5,dy=-0.5,dz=-0.5,tag=!yrh.011.shoot.attacker] run damage @s 8.0 player_attack by @p[tag=yrh.011.shoot.attacker]
...
# ループ
execute positioned ^ ^ ^0.5 run function yrh.011:items/tristeamowl/shoot/strong